 ...
 */
/* Compiler settings for C:/Users/ascoltat0/Desktop/Lab4/COM+CMake/ComSampleProxy/IComTest.idl:
...
#ifndef __IZSS_FWD_DEFINED__
#define __IZSS_FWD_DEFINED__
typedef interface IZSS IZSS;

#endif 	/* __IZSS_FWD_DEFINED__ */
...
#ifndef __IZSS_INTERFACE_DEFINED__
#define __IZSS_INTERFACE_DEFINED__

/* interface IZSS */
/* [helpstring][version][uuid][object] */ 


EXTERN_C const IID IID_IZSS;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("AEC109A3-62A1-4FAA-BFDC-C433B1C4CF70")
    IZSS : public IUnknown
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE reverseNumber( 
            /* [in] */ int x,
    ...
    typedef struct IZSSVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IZSS, reverseNumber)
        HRESULT ( STDMETHODCALLTYPE *reverseNumber )( 
            IZSS * This,
            /* [in] */ int x,
    ...
    interface IZSS
    {
        CONST_VTBL struct IZSSVtbl *lpVtbl;
    };
...
#define IZSS_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IZSS_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IZSS_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IZSS_reverseNumber(This,x,result)	\
    ( (This)->lpVtbl -> reverseNumber(This,x,result) ) 
...
#endif 	/* __IZSS_INTERFACE_DEFINED__ */
