...
extern const MIDL_SERVER_INFO IZSS_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IZSS_ProxyInfo;
...
/* Object interface: IZSS, ver. 1.0,
   GUID={0xAEC109A3,0x62A1,0x4FAA,{0xBF,0xDC,0xC4,0x33,0xB1,0xC4,0xCF,0x70}} */

#pragma code_seg(".orpc")
static const unsigned short IZSS_FormatStringOffsetTable[] =
    {
    38
    };

static const MIDL_STUBLESS_PROXY_INFO IZSS_ProxyInfo =
    {
    &Object_StubDesc,
    IComTest__MIDL_ProcFormatString.Format,
    &IZSS_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IZSS_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    IComTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _IZSSProxyVtbl = 
{
    &IZSS_ProxyInfo,
    &IID_IZSS,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IZSS::reverseNumber */
};

const CInterfaceStubVtbl _IZSSStubVtbl =
{
    &IID_IZSS,
    &IZSS_ServerInfo,
    4,
...
const CInterfaceProxyVtbl * const _IComTest_ProxyVtblList[] = 
{
    ...
    ( CInterfaceProxyVtbl *) &_IZSSProxyVtbl,
    0
};
...
const CInterfaceStubVtbl * const _IComTest_StubVtblList[] = 
{
    ...
    ( CInterfaceStubVtbl *) &_IZSSStubVtbl,
    0
};
