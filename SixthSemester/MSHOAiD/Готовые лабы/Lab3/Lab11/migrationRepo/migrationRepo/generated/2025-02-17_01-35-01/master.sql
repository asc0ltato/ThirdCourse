...
PROMPT Creating Primary Key Constraint PK__Cars__523653D912F129B4 on table Cars ... 
ALTER TABLE Cars
ADD CONSTRAINT PK__Cars__523653D912F129B4 PRIMARY KEY
(
  Car_ID
)
ENABLE
...
GRANT ALL ON Cars TO ROLE_migrationRepo;
...
CREATE TABLE Orders (
  ...
  Start_DateTime VARCHAR2(200 CHAR),
  End_DateTime VARCHAR2(200 CHAR)
);


PROMPT Creating Primary Key Constraint PK__Orders__F1E4639B9FEDA41A on table Orders ... 
ALTER TABLE Orders
ADD CONSTRAINT PK__Orders__F1E4639B9FEDA41A PRIMARY KEY
(
  Order_ID
)
ENABLE
...
PROMPT Creating Primary Key Constraint PK__Payments__DA6C7FE1438C6A4B on table Payments ... 
ALTER TABLE Payments
ADD CONSTRAINT PK__Payments__DA6C7FE1438C6A4B PRIMARY KEY
(
  Payment_ID
)
ENABLE
...
GRANT ALL ON Payments TO ROLE_migrationRepo;
...
CREATE TABLE Users (
  ...
  Drivers_License VARCHAR2(20 CHAR)
);


PROMPT Creating Primary Key Constraint PK__Users__206D9190A33C9CAE on table Users ... 
ALTER TABLE Users
ADD CONSTRAINT PK__Users__206D9190A33C9CAE PRIMARY KEY
(
  User_ID
)
ENABLE
;
PROMPT Creating Unique Constraint UQ__Users__A9D1053410D73AB8 on table Users
ALTER TABLE Users
ADD CONSTRAINT UQ__Users__A9D1053410D73AB8 UNIQUE (
  Email
)
ENABLE
;
...
PROMPT Creating Primary Key Constraint PK__Status__519009ACC022F20F on table Status ... 
ALTER TABLE Status
ADD CONSTRAINT PK__Status__519009ACC022F20F PRIMARY KEY
(
  Status_ID
)
ENABLE
...
GRANT ALL ON Status TO ROLE_migrationRepo;
...
PROMPT Creating Primary Key Constraint PK__Role__D80AB49BB8FA99CB on table Role ... 
ALTER TABLE Role
ADD CONSTRAINT PK__Role__D80AB49BB8FA99CB PRIMARY KEY
(
  Role_ID
)
ENABLE
...
GRANT ALL ON Role TO ROLE_migrationRepo;
...
alter session set current_schema=Rent;
set define off
PROMPT Creating Foreign Key Constraint FK__Cars__Status_ID__3B75D760 on table Status...
ALTER TABLE Cars
ADD CONSTRAINT FK__Cars__Status_ID__3B75D760 FOREIGN KEY
(
  Status_ID
)
REFERENCES Status
...
PROMPT Creating Foreign Key Constraint FK__Orders__Payment___45F365D3 on table Payments...
ALTER TABLE Orders
ADD CONSTRAINT FK__Orders__Payment___45F365D3 FOREIGN KEY
(
  Payment_ID
)
REFERENCES Payments
...
PROMPT Creating Foreign Key Constraint FK__Orders__User_ID__440B1D61 on table Users...
ALTER TABLE Orders
ADD CONSTRAINT FK__Orders__User_ID__440B1D61 FOREIGN KEY
(
  User_ID
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Users__Drivers_L__3F466844 on table Role...
ALTER TABLE Users
ADD CONSTRAINT FK__Users__Drivers_L__3F466844 FOREIGN KEY
(
  Role_ID
)
REFERENCES Role
...
PROMPT Creating Foreign Key Constraint FK__Orders__Car_ID__44FF419A on table Cars...
ALTER TABLE Orders
ADD CONSTRAINT FK__Orders__Car_ID__44FF419A FOREIGN KEY
(
  Car_ID
)
REFERENCES Cars
